...
export const takeaways = [
    ...
    <div><span className={`emphasis`}>Validate the feature set and challenge it when appropriate. </span>For example, Speaker Mode might add undesirable cognitive load to a speaker who is curating the ConvoScope content while simultaneously giving the lecture. Given more time, gathering data around this and exploring other alternatives, could lead to a better product in the long run.</div>,
